...
mpdicon:buttons(awful.util.table.join(
    awful.button({ modkey }, 1, function () awful.util.spawn_with_shell(musicplr) end),
    awful.button({ }, 1, function () awful.util.spawn_with_shell("mpc prev") end),
    awful.button({ }, 2, function () awful.util.spawn_with_shell("mpc toggle") end),
    awful.button({ }, 3, function () awful.util.spawn_with_shell("mpc next") end)))
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#4B3B51", "#787878"),
            wibox.container.background(wibox.container.margin(wibox.widget { fsicon, theme.fs.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#787878"),
            arrow("#787878", "#C0C0A2"),
